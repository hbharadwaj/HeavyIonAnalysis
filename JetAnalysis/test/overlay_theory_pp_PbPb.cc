...
void write_theory(TString out_filename){
    ...
    Double_t vacuum_center[] = {13.0683,6.05378,2.13907,1.03629};

    Double_t vacuum_err[] = {0.10338,0.0792633,0.045846,0.0215134};
    Double_t medium_up[] = {14.9550510405034,5.62575321082284,1.43742637511477,0.568876722356109};
    Double_t medium_do[] = {14.8454329814966,5.54964075257716,1.39893946988523,0.553101771203891};
    Double_t ratio_up[] = {1.15012922268495,0.936631956614026,0.679808438173914,0.554917046379899};
    Double_t ratio_do[] = {1.13023501918278,0.909387218744179,0.646172406305229,0.527770708553566};
    ...
    auto vacuum_graph = new TGraphAsymmErrors(nbins,bin_center,vacuum_center,errx_do,errx_up,vacuum_do,vacuum_up);
    auto medium_graph = new TGraphAsymmErrors(nbins,bin_center,medium_center,errx_do,errx_up,medium_do,medium_up);
    auto ratio_graph  = new TGraphAsymmErrors(nbins,bin_center,ratio_center ,errx_do,errx_up, ratio_do,ratio_up );
