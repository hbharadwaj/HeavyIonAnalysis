// To run 
// combine_mat({"../Unfolded_Plots/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_JER_nom_matinvert_angu_bin_1/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_JER_nom_matinvert_angu_bin_1.root","../Unfolded_Plots/OutputUnfolded_Data_0_30_Mar_10_ABCD_purity_JER_nom_matinvert_angu_bin_1/OutputUnfolded_Data_0_30_Mar_10_ABCD_purity_JER_nom_matinvert_angu_bin_1.root","../Unfolded_Plots/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_JEC_up_matinvert_angu_bin_1/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_JEC_up_matinvert_angu_bin_1.root","../Unfolded_Plots/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_JEC_down_matinvert_angu_bin_1/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_JEC_down_matinvert_angu_bin_1.root","../Unfolded_Plots/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_JER_up_matinvert_angu_bin_1/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_JER_up_matinvert_angu_bin_1.root","../Unfolded_Plots/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_JER_down_matinvert_angu_bin_1/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_JER_down_matinvert_angu_bin_1.root","../Unfolded_Plots/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_JER_nom_response_matinvert_angu_bin_1/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_JER_nom_response_matinvert_angu_bin_1.root","../Unfolded_Plots/OutputUnfolded_Data_0_30_Mar_10_Substructure_up_matinvert_angu_bin_1/OutputUnfolded_Data_0_30_Mar_10_Substructure_up_matinvert_angu_bin_1.root","../Unfolded_Plots/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_cent_up_matinvert_angu_bin_1/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_cent_up_matinvert_angu_bin_1.root","../Unfolded_Plots/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_cent_down_matinvert_angu_bin_1/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_cent_down_matinvert_angu_bin_1.root","../Unfolded_Plots/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_RefParton_matinvert_angu_bin_1/OutputUnfolded_Data_0_30_Mar_10_QCDPhoton_RefParton_matinvert_angu_bin_1.root"},{"nom","ABCD","JECup","JECdown","JERup","JERdown","response","Substructure_up","Centup","Centdown","Pythia_qg","Data_0_30_Mar_10_angu_matinvert"},"Data_0_30_Mar_10_angu_matinvert.root","OutputCombined/","matinvert_X")
// combine_mat({"Pythia8_nom","ABCD_purity","JER_up","JER_down","JEC_up","JEC_down","Cent_up","Cent_down","PFScale_up","PFScale_down","AltMC","response"},{"nom","ABCD","JERup","JERdown","JECup","JECdown","Centup","Centdown","Substructure_up","Substructure_down","AltMC","response","Data_0_30_Apr_11_Rg_matinvert"},"Data_0_30_Apr_11_Rg_matinvert.root","OutputCombined/","matinvert_X")
// combine_mat({"Pythia8_nom","ABCD_purity","JER_up","JER_down","JEC_up","JEC_down","Cent_up","Cent_down","PFScale_up","PFScale_down","AltMC","response"},{"nom","ABCD","JERup","JERdown","JECup","JECdown","Centup","Centdown","Substructure_up","Substructure_down","AltMC","response"})
// plot_combine_mat("OutputCombined/Data_0_30_Mar_10_Rg_matinvert.root","Data_0_30_Mar_10_Rg_matinvert")
//---------------------------
...
TString label="Apr_26_PbPb_2018_sys_allgenjets_matinvert"+TString("_Data");
...
void combine_mat(TString in_varname="",TString out_filename="",TString out_filepath="", TString hname="matinvert_X"){ // "matinvert_X"
    ...
    std::vector<TString>sel = {Form("#gamma p_{T}>%.0f, x_{J}>%.2f, Anti-#it{k}_{T} #it{R}=0.2",100.0,0.4),"  ","Matrix Inverted","z_{cut}=0.2"};   
...
void plot_combine_mat(TString hname,TString file="", TString label_in="", TString out_path=""){
    label = hname;
    if(label_in!="")
        label=label_in;
    if(out_path!="")
    ...
    // Input Histograms 
        ...
        // 0 -> nominal 
        // 1 -> Photon Purity -> ABCD
        // 2 -> JEC up
        // 3 -> JEC down
        // 4 -> JER up
        // 5 -> JER down
        // 6 -> Response matrix Stats
        // 7 -> Substructure up
        // 8 -> Substructure down
        // 9 -> Cent up
        //10 -> Cent down
        //11 -> MC Modelling - q/g Modified
        //12 -> MC Modelling - q/g Modified
    ...
    for(Int_t j=0;j<=hinput[0]->GetNbinsX()+2;j++){ 
        ...
        // Photon Purity -> Symmetrized
            Double_t erry_purity_a = fabs(-1*hinput[0]->GetBinContent(j)+hinput[1]->GetBinContent(j));   
            Double_t erry_purity_b = erry_purity_a;

        // JEC
            Double_t erry_JEC_a = fabs(-1*hinput[0]->GetBinContent(j)+hinput[2]->GetBinContent(j));   
            Double_t erry_JEC_b = fabs(-1*hinput[0]->GetBinContent(j)+hinput[3]->GetBinContent(j));
        // JER
            Double_t erry_JER_a = fabs(-1*hinput[0]->GetBinContent(j)+hinput[4]->GetBinContent(j));   
            Double_t erry_JER_b = fabs(-1*hinput[0]->GetBinContent(j)+hinput[5]->GetBinContent(j));
        
        // Response Matrix Stats
            Double_t erry_response_a = fabs(hinput[6]->GetBinError(j));   
            Double_t erry_response_b = erry_response_a;

        // Substructure
            Double_t erry_substructure_a = fabs(-1*hinput[0]->GetBinContent(j)+hinput[7]->GetBinContent(j));   
            Double_t erry_substructure_b = fabs(-1*hinput[0]->GetBinContent(j)+hinput[8]->GetBinContent(j));
        
        // Centrality
            Double_t erry_cent_a = fabs(-1*hinput[0]->GetBinContent(j)+hinput[9]->GetBinContent(j));   
            Double_t erry_cent_b = fabs(-1*hinput[0]->GetBinContent(j)+hinput[10]->GetBinContent(j));
        ...
        // Pythia q/g Prior
            ...
            Double_t erry_Pythia_prior_a = fabs(hinput[11]->GetBinContent(j)-hinput[0]->GetBinContent(j));   // q/g Modified
            Double_t erry_Pythia_prior_b = fabs(hinput[12]->GetBinContent(j)-hinput[0]->GetBinContent(j));  // q/g Modified

        Double_t erry_uncorr_up = TMath::Sqrt(erry_purity_a*erry_purity_a + erry_JEC_a*erry_JEC_a + erry_JER_a*erry_JER_a + erry_response_a*erry_response_a + erry_substructure_a*erry_substructure_a + erry_cent_a*erry_cent_a + erry_Pythia_prior_a*erry_Pythia_prior_a); // 
        Double_t erry_uncorr_do = TMath::Sqrt(erry_purity_b*erry_purity_b + erry_JEC_b*erry_JEC_b + erry_JER_b*erry_JER_b + erry_response_b*erry_response_b + erry_substructure_b*erry_substructure_b + erry_cent_b*erry_cent_b + erry_Pythia_prior_b*erry_Pythia_prior_b); //  
    ...
    std::vector<TString>sel = {" ","PbPb 1.69 nb^{-1}(5.02 TeV)","Cent. 0-30%",Form("#gamma p_{T}>%.0f, x_{J}>%.1f,|#Delta #phi_{#gamma,jet}|>#frac{2}{3}#pi",100.0,0.4),"Matrix Inversion"}; 
    if(label.Contains("Rg")){
        ...
        // Plot_hist_err({hinput[0]},{sys_uncert},{"sys. uncert","Angularity (#mathrm{g})","1/N_{jet} dN/d#mathrm{g}",label+"_combined"},"right_label",sel);
    }
    ...
    // }
    // else{
    //     histname_input_ratio.push_back("Girth");
    // }
    ...
    if(label.Contains("Rg")){
        ...
        histname_input_ratio_up.push_back("Girth");
        histname_input_ratio_down.push_back("Girth");
    }
...
int main(int argc, char* argv[]){
    if(argc==2){ //! Correct this
        plot_combine_mat(argv[1],argv[2]);
    }
    else{
        printf("Run with \n ./plot_combine_mat .....\n");
    }
...
// 15 Color-Blind Friendly RGB
    ...
    if(label.Contains("Data"))
        latex.DrawLatexNDC(0.1,0.9,"CMS #it{#bf{Preliminary}} PbPb 1.69 nb^{-1}(5.02 TeV)");
    else
