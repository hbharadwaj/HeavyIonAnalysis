...
void combine(TString in_varname="",int iter_ref = 6,int iter_prior = 13,TString out_filename="",TString out_filepath="", TString hname="unfold_X"){
    ...
    std::vector<TString> file_list  = {"Pythia8_nom","ABCD_purity","JER_up","JER_down","JEC_up","JEC_down","Cent_up","Cent_down","PScale_up","PScale_down","ChScale_up","ChScale_down","NScale_up","NScale_down","AltMC","response"};
    std::vector<TString> label_list = {"nom","ABCD","JERup","JERdown","JECup","JECdown","Centup","Centdown","Photon_up","Photon_down","Charged_up","Charged_down","Neutral_up","Neutral_down","AltMC","response"};
    if(in_varname!="")
        varname=in_varname;
    if(out_filepath!="")
...
void plot_combine(TString hname,TString file="", TString label_in="", TString out_path=""){
    ...
    // Input Histograms 
        ...
        //15 -> Cent up
        //16 -> Cent down
        //17 -> MC Modelling - q/g Modified
        //18 -> MC Modelling - q/g Modified
