...
ak3CaloPfImpactParameterTagInfos = ak3CalobTagger.PfImpactParameterTagInfos
...
ak3CaloCombinedSecondaryVertexBJetTags = ak3CalobTagger.CombinedSecondaryVertexBJetTags
ak3CaloCombinedSecondaryVertexV2BJetTags = ak3CalobTagger.CombinedSecondaryVertexV2BJetTags
ak3CaloPfInclusiveSecondaryVertexFinderTagInfos = ak3CalobTagger.PfInclusiveSecondaryVertexFinderTagInfos
ak3CaloPfDeepCSVTagInfos = ak3CalobTagger.PfDeepCSVTagInfos
ak3CaloPfDeepCSVJetTags = ak3CalobTagger.PfDeepCSVJetTags
...
ak3CaloJetBtaggingIP       = cms.Sequence(ak3CaloImpactParameterTagInfos *
	     ...
	     ak3CaloPfImpactParameterTagInfos 
            )
...
ak3CaloJetBtaggingSV = cms.Sequence(ak3CaloImpactParameterTagInfos
	    ...
	    ak3CaloPfImpactParameterTagInfos *
	    ak3CaloPfInclusiveSecondaryVertexFinderTagInfos *
	    ak3CaloPfDeepCSVTagInfos *
	    ak3CaloPfDeepCSVJetTags  
            )
...
ak3CalopatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("ak3CaloJets"),
	...
	useLegacyJetMCFlavour = False,
        discriminatorSources = cms.VInputTag(cms.InputTag("ak3CaloSimpleSecondaryVertexHighEffBJetTags"),
            ...
            cms.InputTag("ak3CaloPfDeepCSVJetTags:probb")
...
ak3CalopatJetsWithBtagging.getJetMCFlavour = False
ak3CaloJetAnalyzer.doExtendedFlavorTagging = False

ak3CaloJetAnalyzer.trackSelection = ak3CaloSecondaryVertexTagInfos.trackSelection
ak3CaloJetAnalyzer.trackPairV0Filter = ak3CaloSecondaryVertexTagInfos.vertexCuts.v0Filter
...
ak3CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #DISABLE_PPCALO_ak3CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #DISABLE_PPCALO_*
                                                  ak3CaloJetTracksAssociatorAtVertex
                                                  *
                                                  ak3CaloJetBtagging
                                                  *
                                                  #DISABLE_PPCALO_ak3CaloNjettiness
                                                  #DISABLE_PPCALO_*
