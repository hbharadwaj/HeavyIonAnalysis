...
akPu2CalopfImpactParameterTagInfos = akPu2CalobTagger.pfImpactParameterTagInfos
...
akPu2CalopfSecondaryVertexTagInfos = akPu2CalobTagger.pfSecondaryVertexTagInfos
akPu2CalopfDeepCSVTagInfos = akPu2CalobTagger.pfDeepCSVTagInfos
akPu2CalopfDeepCSVJetTags = akPu2CalobTagger.pfDeepCSVJetTags
...
akPu2CaloJetCandBtagging = cms.Sequence(akPu2CalopfImpactParameterTagInfos *
    akPu2CalopfSecondaryVertexTagInfos *
    akPu2CalopfDeepCSVTagInfos *
    akPu2CalopfDeepCSVJetTags
    )
...
akPu2CalopatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akPu2CalopfDeepCSVJetTags:probb"),
        cms.InputTag("akPu2CalopfDeepCSVJetTags:probc"),
        cms.InputTag("akPu2CalopfDeepCSVJetTags:probudsg"),
        cms.InputTag("akPu2CalopfDeepCSVJetTags:probbb"),
        ),
