...
akFlowPuCs3PFPatJetPartonAssociationLegacy.partons = "myPartons"
...
akFlowPuCs3PFJetAnalyzer.matchJets = cms.untracked.bool(True)
akFlowPuCs3PFJetAnalyzer.matchTag = cms.untracked.InputTag("ak3PFpatJetsWithBtagging")
