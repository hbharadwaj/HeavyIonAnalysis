...
akPu1CalopfImpactParameterTagInfos = akPu1CalobTagger.pfImpactParameterTagInfos
...
akPu1CalopfSecondaryVertexTagInfos = akPu1CalobTagger.pfSecondaryVertexTagInfos
akPu1CalopfDeepCSVTagInfos = akPu1CalobTagger.pfDeepCSVTagInfos
akPu1CalopfDeepCSVJetTags = akPu1CalobTagger.pfDeepCSVJetTags
...
akPu1CaloJetCandBtagging = cms.Sequence(akPu1CalopfImpactParameterTagInfos *
    akPu1CalopfSecondaryVertexTagInfos *
    akPu1CalopfDeepCSVTagInfos *
    akPu1CalopfDeepCSVJetTags
    )
...
akPu1CalopatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akPu1CalopfDeepCSVJetTags:probb"),
        cms.InputTag("akPu1CalopfDeepCSVJetTags:probc"),
        cms.InputTag("akPu1CalopfDeepCSVJetTags:probudsg"),
        cms.InputTag("akPu1CalopfDeepCSVJetTags:probbb"),
        ),
