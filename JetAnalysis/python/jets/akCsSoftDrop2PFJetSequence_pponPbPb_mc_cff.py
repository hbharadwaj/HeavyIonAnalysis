...
akCsSoftDrop2PFpfImpactParameterTagInfos = akCsSoftDrop2PFbTagger.pfImpactParameterTagInfos
...
akCsSoftDrop2PFpfSecondaryVertexTagInfos = akCsSoftDrop2PFbTagger.pfSecondaryVertexTagInfos
akCsSoftDrop2PFpfDeepCSVTagInfos = akCsSoftDrop2PFbTagger.pfDeepCSVTagInfos
akCsSoftDrop2PFpfDeepCSVJetTags = akCsSoftDrop2PFbTagger.pfDeepCSVJetTags
...
akCsSoftDrop2PFJetCandBtagging = cms.Sequence(akCsSoftDrop2PFpfImpactParameterTagInfos *
    akCsSoftDrop2PFpfSecondaryVertexTagInfos *
    akCsSoftDrop2PFpfDeepCSVTagInfos *
    akCsSoftDrop2PFpfDeepCSVJetTags
    )
...
akCsSoftDrop2PFJetBtagging = cms.Sequence(
    ...
    * akCsSoftDrop2PFJetCandBtagging
...
akCsSoftDrop2PFpatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akCsSoftDrop2PFpfDeepCSVJetTags:probb"),
        cms.InputTag("akCsSoftDrop2PFpfDeepCSVJetTags:probc"),
        cms.InputTag("akCsSoftDrop2PFpfDeepCSVJetTags:probudsg"),
        cms.InputTag("akCsSoftDrop2PFpfDeepCSVJetTags:probbb"),
        ),
    tagInfoSources = cms.VInputTag(cms.InputTag("akCsSoftDrop2PFImpactParameterTagInfos"),cms.InputTag("akCsSoftDrop2PFSecondaryVertexTagInfos")),
...
akCsSoftDrop2PFJetAnalyzer.matchJets = cms.untracked.bool(True)
akCsSoftDrop2PFJetAnalyzer.matchTag = cms.untracked.InputTag("ak2PFpatJetsWithBtagging")
