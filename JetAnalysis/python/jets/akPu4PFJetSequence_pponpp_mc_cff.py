...
akPu4PFpfImpactParameterTagInfos = akPu4PFbTagger.pfImpactParameterTagInfos
...
akPu4PFpfSecondaryVertexTagInfos = akPu4PFbTagger.pfSecondaryVertexTagInfos
akPu4PFpfDeepCSVTagInfos = akPu4PFbTagger.pfDeepCSVTagInfos
akPu4PFpfDeepCSVJetTags = akPu4PFbTagger.pfDeepCSVJetTags
...
akPu4PFJetCandBtagging = cms.Sequence(akPu4PFpfImpactParameterTagInfos *
    akPu4PFpfSecondaryVertexTagInfos *
    akPu4PFpfDeepCSVTagInfos *
    akPu4PFpfDeepCSVJetTags
    )
...
akPu4PFpatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akPu4PFpfDeepCSVJetTags:probb"),
        cms.InputTag("akPu4PFpfDeepCSVJetTags:probc"),
        cms.InputTag("akPu4PFpfDeepCSVJetTags:probudsg"),
        cms.InputTag("akPu4PFpfDeepCSVJetTags:probbb"),
        ),
