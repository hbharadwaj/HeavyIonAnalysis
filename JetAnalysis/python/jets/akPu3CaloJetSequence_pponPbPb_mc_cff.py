...
akPu3CalopfImpactParameterTagInfos = akPu3CalobTagger.pfImpactParameterTagInfos
...
akPu3CalopfSecondaryVertexTagInfos = akPu3CalobTagger.pfSecondaryVertexTagInfos
akPu3CalopfDeepCSVTagInfos = akPu3CalobTagger.pfDeepCSVTagInfos
akPu3CalopfDeepCSVJetTags = akPu3CalobTagger.pfDeepCSVJetTags
...
akPu3CaloJetCandBtagging = cms.Sequence(akPu3CalopfImpactParameterTagInfos *
    akPu3CalopfSecondaryVertexTagInfos *
    akPu3CalopfDeepCSVTagInfos *
    akPu3CalopfDeepCSVJetTags
    )
...
akPu3CalopatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akPu3CalopfDeepCSVJetTags:probb"),
        cms.InputTag("akPu3CalopfDeepCSVJetTags:probc"),
        cms.InputTag("akPu3CalopfDeepCSVJetTags:probudsg"),
        cms.InputTag("akPu3CalopfDeepCSVJetTags:probbb"),
        ),
