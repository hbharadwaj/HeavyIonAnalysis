...
akFlowPuCs1PFPatJetPartonAssociationLegacy.partons = "myPartons"
...
akFlowPuCs1PFJetAnalyzer.matchJets = cms.untracked.bool(True)
akFlowPuCs1PFJetAnalyzer.matchTag = cms.untracked.InputTag("ak1PFpatJetsWithBtagging")
