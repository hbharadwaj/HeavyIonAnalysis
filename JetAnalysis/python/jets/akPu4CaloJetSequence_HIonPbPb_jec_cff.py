...
akPu4CalopfImpactParameterTagInfos = akPu4CalobTagger.pfImpactParameterTagInfos
...
akPu4CalopfSecondaryVertexTagInfos = akPu4CalobTagger.pfSecondaryVertexTagInfos
akPu4CalopfDeepCSVTagInfos = akPu4CalobTagger.pfDeepCSVTagInfos
akPu4CalopfDeepCSVJetTags = akPu4CalobTagger.pfDeepCSVJetTags
...
akPu4CaloJetCandBtagging = cms.Sequence(akPu4CalopfImpactParameterTagInfos *
    akPu4CalopfSecondaryVertexTagInfos *
    akPu4CalopfDeepCSVTagInfos *
    akPu4CalopfDeepCSVJetTags
    )
...
akPu4CalopatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akPu4CalopfDeepCSVJetTags:probb"),
        cms.InputTag("akPu4CalopfDeepCSVJetTags:probc"),
        cms.InputTag("akPu4CalopfDeepCSVJetTags:probudsg"),
        cms.InputTag("akPu4CalopfDeepCSVJetTags:probbb"),
        ),
