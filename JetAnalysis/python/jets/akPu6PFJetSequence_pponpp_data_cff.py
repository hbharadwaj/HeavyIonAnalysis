...
akPu6PFpfImpactParameterTagInfos = akPu6PFbTagger.pfImpactParameterTagInfos
...
akPu6PFpfSecondaryVertexTagInfos = akPu6PFbTagger.pfSecondaryVertexTagInfos
akPu6PFpfDeepCSVTagInfos = akPu6PFbTagger.pfDeepCSVTagInfos
akPu6PFpfDeepCSVJetTags = akPu6PFbTagger.pfDeepCSVJetTags
...
akPu6PFJetCandBtagging = cms.Sequence(akPu6PFpfImpactParameterTagInfos *
    akPu6PFpfSecondaryVertexTagInfos *
    akPu6PFpfDeepCSVTagInfos *
    akPu6PFpfDeepCSVJetTags
    )
...
akPu6PFpatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akPu6PFpfDeepCSVJetTags:probb"),
        cms.InputTag("akPu6PFpfDeepCSVJetTags:probc"),
        cms.InputTag("akPu6PFpfDeepCSVJetTags:probudsg"),
        cms.InputTag("akPu6PFpfDeepCSVJetTags:probbb"),
        ),
    tagInfoSources = cms.VInputTag(cms.InputTag("akPu6PFImpactParameterTagInfos"),cms.InputTag("akPu6PFSecondaryVertexTagInfos")),
