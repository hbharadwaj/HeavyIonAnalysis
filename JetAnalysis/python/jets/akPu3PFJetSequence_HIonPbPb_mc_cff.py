...
akPu3PFpfImpactParameterTagInfos = akPu3PFbTagger.pfImpactParameterTagInfos
...
akPu3PFpfSecondaryVertexTagInfos = akPu3PFbTagger.pfSecondaryVertexTagInfos
akPu3PFpfDeepCSVTagInfos = akPu3PFbTagger.pfDeepCSVTagInfos
akPu3PFpfDeepCSVJetTags = akPu3PFbTagger.pfDeepCSVJetTags
...
akPu3PFJetCandBtagging = cms.Sequence(akPu3PFpfImpactParameterTagInfos *
    akPu3PFpfSecondaryVertexTagInfos *
    akPu3PFpfDeepCSVTagInfos *
    akPu3PFpfDeepCSVJetTags
    )
...
akPu3PFpatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akPu3PFpfDeepCSVJetTags:probb"),
        cms.InputTag("akPu3PFpfDeepCSVJetTags:probc"),
        cms.InputTag("akPu3PFpfDeepCSVJetTags:probudsg"),
        cms.InputTag("akPu3PFpfDeepCSVJetTags:probbb"),
        ),
