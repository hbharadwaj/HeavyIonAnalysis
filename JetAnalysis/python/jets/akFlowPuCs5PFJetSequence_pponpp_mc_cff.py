...
akFlowPuCs5PFPatJetPartonAssociationLegacy.partons = "myPartons"
...
akFlowPuCs5PFJetAnalyzer.matchJets = cms.untracked.bool(True)
akFlowPuCs5PFJetAnalyzer.matchTag = cms.untracked.InputTag("ak5PFpatJetsWithBtagging")
