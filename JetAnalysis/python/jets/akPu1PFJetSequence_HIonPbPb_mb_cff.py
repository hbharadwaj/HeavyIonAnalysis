...
akPu1PFpfImpactParameterTagInfos = akPu1PFbTagger.pfImpactParameterTagInfos
...
akPu1PFpfSecondaryVertexTagInfos = akPu1PFbTagger.pfSecondaryVertexTagInfos
akPu1PFpfDeepCSVTagInfos = akPu1PFbTagger.pfDeepCSVTagInfos
akPu1PFpfDeepCSVJetTags = akPu1PFbTagger.pfDeepCSVJetTags
...
akPu1PFJetCandBtagging = cms.Sequence(akPu1PFpfImpactParameterTagInfos *
    akPu1PFpfSecondaryVertexTagInfos *
    akPu1PFpfDeepCSVTagInfos *
    akPu1PFpfDeepCSVJetTags
    )
...
akPu1PFpatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akPu1PFpfDeepCSVJetTags:probb"),
        cms.InputTag("akPu1PFpfDeepCSVJetTags:probc"),
        cms.InputTag("akPu1PFpfDeepCSVJetTags:probudsg"),
        cms.InputTag("akPu1PFpfDeepCSVJetTags:probbb"),
        ),
