...
akFlowPuCsSoftDrop3PFJetSequence = cms.Sequence(
    akFlowPuCsSoftDrop3PFJetSequence_jec)
akFlowPuCsSoftDrop3PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akFlowPuCsSoftDrop3PFJetAnalyzer.jetPtMin = cms.double(1)
