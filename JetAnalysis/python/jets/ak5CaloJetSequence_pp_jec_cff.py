...
ak5CaloPfImpactParameterTagInfos = ak5CalobTagger.PfImpactParameterTagInfos
...
ak5CaloCombinedSecondaryVertexBJetTags = ak5CalobTagger.CombinedSecondaryVertexBJetTags
ak5CaloCombinedSecondaryVertexV2BJetTags = ak5CalobTagger.CombinedSecondaryVertexV2BJetTags
ak5CaloPfInclusiveSecondaryVertexFinderTagInfos = ak5CalobTagger.PfInclusiveSecondaryVertexFinderTagInfos
ak5CaloPfDeepCSVTagInfos = ak5CalobTagger.PfDeepCSVTagInfos
ak5CaloPfDeepCSVJetTags = ak5CalobTagger.PfDeepCSVJetTags
...
ak5CaloJetBtaggingIP       = cms.Sequence(ak5CaloImpactParameterTagInfos *
	     ...
	     ak5CaloPfImpactParameterTagInfos 
            )
...
ak5CaloJetBtaggingSV = cms.Sequence(ak5CaloImpactParameterTagInfos
	    ...
	    ak5CaloPfImpactParameterTagInfos *
	    ak5CaloPfInclusiveSecondaryVertexFinderTagInfos *
	    ak5CaloPfDeepCSVTagInfos *
	    ak5CaloPfDeepCSVJetTags  
            )
...
ak5CalopatJetsWithBtagging = patJets.clone(jetSource = cms.InputTag("ak5CaloJets"),
	...
	useLegacyJetMCFlavour = False,
        discriminatorSources = cms.VInputTag(cms.InputTag("ak5CaloSimpleSecondaryVertexHighEffBJetTags"),
            ...
            cms.InputTag("ak5CaloPfDeepCSVJetTags:probb")
...
ak5CalopatJetsWithBtagging.getJetMCFlavour = False
ak5CaloJetAnalyzer.doExtendedFlavorTagging = False

ak5CaloJetAnalyzer.trackSelection = ak5CaloSecondaryVertexTagInfos.trackSelection
ak5CaloJetAnalyzer.trackPairV0Filter = ak5CaloSecondaryVertexTagInfos.vertexCuts.v0Filter
...
ak5CaloJetSequence_mc = cms.Sequence(
                                                  ...
                                                  *
                                                  ...
                                                  #*
                                                  #DISABLE_PPCALO_ak5CaloPatJetFlavourId  # doesn't work for PbPb yet
                                                  #DISABLE_PPCALO_*
                                                  ak5CaloJetTracksAssociatorAtVertex
                                                  *
                                                  ak5CaloJetBtagging
                                                  *
                                                  #DISABLE_PPCALO_ak5CaloNjettiness
                                                  #DISABLE_PPCALO_*
