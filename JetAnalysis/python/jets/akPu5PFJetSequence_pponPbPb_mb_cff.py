...
akPu5PFpfImpactParameterTagInfos = akPu5PFbTagger.pfImpactParameterTagInfos
...
akPu5PFpfSecondaryVertexTagInfos = akPu5PFbTagger.pfSecondaryVertexTagInfos
akPu5PFpfDeepCSVTagInfos = akPu5PFbTagger.pfDeepCSVTagInfos
akPu5PFpfDeepCSVJetTags = akPu5PFbTagger.pfDeepCSVJetTags
...
akPu5PFJetCandBtagging = cms.Sequence(akPu5PFpfImpactParameterTagInfos *
    akPu5PFpfSecondaryVertexTagInfos *
    akPu5PFpfDeepCSVTagInfos *
    akPu5PFpfDeepCSVJetTags
    )
...
akPu5PFpatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akPu5PFpfDeepCSVJetTags:probb"),
        cms.InputTag("akPu5PFpfDeepCSVJetTags:probc"),
        cms.InputTag("akPu5PFpfDeepCSVJetTags:probudsg"),
        cms.InputTag("akPu5PFpfDeepCSVJetTags:probbb"),
        ),
    tagInfoSources = cms.VInputTag(cms.InputTag("akPu5PFImpactParameterTagInfos"),cms.InputTag("akPu5PFSecondaryVertexTagInfos")),
