...
akFlowPuCsSoftDrop4PFPatJetPartonAssociationLegacy.partons = "signalPartons"
...
akFlowPuCsSoftDrop4PFJetSequence = cms.Sequence(
    akFlowPuCsSoftDrop4PFJetSequence_jec)
akFlowPuCsSoftDrop4PFJetAnalyzer.genPtMin = cms.untracked.double(1)
akFlowPuCsSoftDrop4PFJetAnalyzer.jetPtMin = cms.double(1)
