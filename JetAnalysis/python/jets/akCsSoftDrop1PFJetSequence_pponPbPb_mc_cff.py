...
akCsSoftDrop1PFpfImpactParameterTagInfos = akCsSoftDrop1PFbTagger.pfImpactParameterTagInfos
...
akCsSoftDrop1PFpfSecondaryVertexTagInfos = akCsSoftDrop1PFbTagger.pfSecondaryVertexTagInfos
akCsSoftDrop1PFpfDeepCSVTagInfos = akCsSoftDrop1PFbTagger.pfDeepCSVTagInfos
akCsSoftDrop1PFpfDeepCSVJetTags = akCsSoftDrop1PFbTagger.pfDeepCSVJetTags
...
akCsSoftDrop1PFJetCandBtagging = cms.Sequence(akCsSoftDrop1PFpfImpactParameterTagInfos *
    akCsSoftDrop1PFpfSecondaryVertexTagInfos *
    akCsSoftDrop1PFpfDeepCSVTagInfos *
    akCsSoftDrop1PFpfDeepCSVJetTags
    )
...
akCsSoftDrop1PFJetBtagging = cms.Sequence(
    ...
    * akCsSoftDrop1PFJetCandBtagging
...
akCsSoftDrop1PFpatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akCsSoftDrop1PFpfDeepCSVJetTags:probb"),
        cms.InputTag("akCsSoftDrop1PFpfDeepCSVJetTags:probc"),
        cms.InputTag("akCsSoftDrop1PFpfDeepCSVJetTags:probudsg"),
        cms.InputTag("akCsSoftDrop1PFpfDeepCSVJetTags:probbb"),
        ),
    tagInfoSources = cms.VInputTag(cms.InputTag("akCsSoftDrop1PFImpactParameterTagInfos"),cms.InputTag("akCsSoftDrop1PFSecondaryVertexTagInfos")),
...
akCsSoftDrop1PFJetAnalyzer.matchJets = cms.untracked.bool(True)
akCsSoftDrop1PFJetAnalyzer.matchTag = cms.untracked.InputTag("ak1PFpatJetsWithBtagging")
