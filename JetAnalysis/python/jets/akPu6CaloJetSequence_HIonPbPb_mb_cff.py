...
akPu6CalopfImpactParameterTagInfos = akPu6CalobTagger.pfImpactParameterTagInfos
...
akPu6CalopfSecondaryVertexTagInfos = akPu6CalobTagger.pfSecondaryVertexTagInfos
akPu6CalopfDeepCSVTagInfos = akPu6CalobTagger.pfDeepCSVTagInfos
akPu6CalopfDeepCSVJetTags = akPu6CalobTagger.pfDeepCSVJetTags
...
akPu6CaloJetCandBtagging = cms.Sequence(akPu6CalopfImpactParameterTagInfos *
    akPu6CalopfSecondaryVertexTagInfos *
    akPu6CalopfDeepCSVTagInfos *
    akPu6CalopfDeepCSVJetTags
    )
...
akPu6CalopatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akPu6CalopfDeepCSVJetTags:probb"),
        cms.InputTag("akPu6CalopfDeepCSVJetTags:probc"),
        cms.InputTag("akPu6CalopfDeepCSVJetTags:probudsg"),
        cms.InputTag("akPu6CalopfDeepCSVJetTags:probbb"),
        ),
    tagInfoSources = cms.VInputTag(cms.InputTag("akPu6CaloImpactParameterTagInfos"),cms.InputTag("akPu6CaloSecondaryVertexTagInfos")),
