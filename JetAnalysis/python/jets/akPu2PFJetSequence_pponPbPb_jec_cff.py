...
akPu2PFpfImpactParameterTagInfos = akPu2PFbTagger.pfImpactParameterTagInfos
...
akPu2PFpfSecondaryVertexTagInfos = akPu2PFbTagger.pfSecondaryVertexTagInfos
akPu2PFpfDeepCSVTagInfos = akPu2PFbTagger.pfDeepCSVTagInfos
akPu2PFpfDeepCSVJetTags = akPu2PFbTagger.pfDeepCSVJetTags
...
akPu2PFJetCandBtagging = cms.Sequence(akPu2PFpfImpactParameterTagInfos *
    akPu2PFpfSecondaryVertexTagInfos *
    akPu2PFpfDeepCSVTagInfos *
    akPu2PFpfDeepCSVJetTags
    )
...
akPu2PFpatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akPu2PFpfDeepCSVJetTags:probb"),
        cms.InputTag("akPu2PFpfDeepCSVJetTags:probc"),
        cms.InputTag("akPu2PFpfDeepCSVJetTags:probudsg"),
        cms.InputTag("akPu2PFpfDeepCSVJetTags:probbb"),
        ),
