...
akCs6PFpfImpactParameterTagInfos = akCs6PFbTagger.pfImpactParameterTagInfos
...
akCs6PFpfSecondaryVertexTagInfos = akCs6PFbTagger.pfSecondaryVertexTagInfos
akCs6PFpfDeepCSVTagInfos = akCs6PFbTagger.pfDeepCSVTagInfos
akCs6PFpfDeepCSVJetTags = akCs6PFbTagger.pfDeepCSVJetTags
...
akCs6PFJetCandBtagging = cms.Sequence(akCs6PFpfImpactParameterTagInfos *
    akCs6PFpfSecondaryVertexTagInfos *
    akCs6PFpfDeepCSVTagInfos *
    akCs6PFpfDeepCSVJetTags
    )
...
akCs6PFpatJetsWithBtagging = patJets.clone(
    ...
    discriminatorSources   = cms.VInputTag(
        ...
        cms.InputTag("akCs6PFpfDeepCSVJetTags:probb"),
        cms.InputTag("akCs6PFpfDeepCSVJetTags:probc"),
        cms.InputTag("akCs6PFpfDeepCSVJetTags:probudsg"),
        cms.InputTag("akCs6PFpfDeepCSVJetTags:probbb"),
        ),
    tagInfoSources = cms.VInputTag(cms.InputTag("akCs6PFImpactParameterTagInfos"),cms.InputTag("akCs6PFSecondaryVertexTagInfos")),
...
akCs6PFJetAnalyzer.matchJets = cms.untracked.bool(True)
akCs6PFJetAnalyzer.matchTag = cms.untracked.InputTag("ak6PFpatJetsWithBtagging")
