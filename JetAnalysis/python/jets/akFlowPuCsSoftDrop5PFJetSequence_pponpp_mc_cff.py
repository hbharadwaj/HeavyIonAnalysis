...
akFlowPuCsSoftDrop5PFPatJetPartonAssociationLegacy.partons = "myPartons"
...
akFlowPuCsSoftDrop5PFJetAnalyzer.matchJets = cms.untracked.bool(True)
akFlowPuCsSoftDrop5PFJetAnalyzer.matchTag = cms.untracked.InputTag("ak5PFpatJetsWithBtagging")
