...
void Cuts(TString prefix = "")
{
    ...
    factory->BookMethod(dataloader, TMVA::Types::kCuts, "Cuts", "V:!H:FitMethod=GA:EffMethod=EffSel:CutRangeMin[0]=-1:CutRangeMax[0]=0.15:CutRangeMin[1]=-1:CutRangeMax[1]=0.011:CutRangeMin[2]=-400:CutRangeMax[2]=5:VarProp=FMin:PopSize=1000:Steps=80"); 
